            ...
            <div class="users-section">
                ...
                <div id="admins-section" class="user-subsection" style="--border-color: #6f42c1; --header-color: #6f42c1;">
                    ...
                    <div class="search-with-filters" style="display: flex; gap: 10px; margin-bottom: 10px; flex-wrap: wrap;">
                        ...
                        <button id="create-admin-btn" class="btn" onclick="openCreateAdminModal()">Create New Admin</button>
                    </div>

                    <div class="bulk-actions" style="margin-bottom: 10px; display: flex; gap: 10px; align-items: center;">
                        <input type="checkbox" id="select-all-admins-main" onclick="toggleSelectAll('admins')">
                        <button class="btn btn-danger" onclick="bulkAction('admins', 'remove')">Remove</button>
                    </div>
                    ...
                    <table>
                        <thead>
                            <tr>
                                <th><input type="checkbox" id="select-all-admins" onclick="toggleSelectAll('admins')"></th>
                                <th>ID</th>
                                <th>Full Name</th>
                                <th>Email</th>
                                <th>Role</th>
                ...
                <div id="verified-section" class="user-subsection" style="--border-color: #28a745; --header-color: #28a745;">
                    ...
                    <div class="bulk-actions" style="margin-bottom: 10px; display: flex; gap: 10px; align-items: center;">
                        ...
                        <button class="btn btn-danger" onclick="bulkAction('verified', 'remove')">Remove</button>
                    </div>
                    
                    <div style="overflow-x: auto;">
                        <table id="verified-users-table">
                                                    <thead><tr><th><input type="checkbox" id="select-all-verified" onclick="toggleSelectAll('verified')"></th><th>ID</th><th>Full Name</th><th>Email</th><th>Role</th><th>Grade</th><th>Sec_Degr</th><th>Date Verified</th><th>Raf/Edu_ID</th><th>Actions</th></tr></thead>
                ...
                <div id="signing-up-section" class="user-subsection" style="--border-color: #ffc107; --header-color: #ffc107;">
                    ...
                    <div class="bulk-actions" style="margin-bottom: 10px; display: flex; gap: 10px; align-items: center;">
                        ...
                        <button class="btn btn-danger" onclick="bulkAction('signing-up', 'remove')">Remove</button>
                    </div>
                    <div style="overflow-x: auto;">
                        <table id="signing-up-users-table">
                                                    <thead><tr><th><input type="checkbox" id="select-all-signing-up" onclick="toggleSelectAll('signing-up')"></th><th>ID</th><th>Full Name</th><th>Email</th><th>Role</th><th>Grade</th><th>Sec_Degr</th><th>Date Signed Up</th><th>Status</th><th>Raf/Edu_ID</th><th>Actions</th></tr></thead>
                ...
                <div id="banned-section" class="user-subsection" style="--border-color: #dc3545; --header-color: #dc3545;">
                    ...
                    <div style="overflow-x: auto;">
                        <table id="banned-users-table">
                                                    <thead><tr><th><input type="checkbox" id="select-all-banned" onclick="toggleSelectAll('banned')"></th><th>ID</th><th>Full Name</th><th>Email</th><th>Role</th><th>Grade</th><th>Sec_Degr</th><th>Date Banned</th><th>Status</th><th>Raf/Edu_ID</th><th>Actions</th></tr></thead>
    ...
    <div id="create-admin-modal" class="modal">
        <div class="modal-content" style="max-height: 600px; overflow-y: auto;">
            <div style="position: relative; margin-bottom: 20px;">
                <h3 style="margin: 0;" id="create-user-modal-title">Create New User</h3>
                <span class="close-modal" onclick="closeCreateAdminModal()" style="position: absolute; right: 0; top: 0; cursor: pointer; font-size: 28px; color: #aaa;">&times;</span>
            </div>
            <form id="create-admin-form" onsubmit="return handleCreateAdminSubmit(event)">
                <!-- Admin Roles Section First -->
                <label style="font-weight: bold; display: block; margin-bottom: 10px;">Admin Role:</label>
                 <div style="display: flex; flex-direction: column; gap: 10px; margin-bottom: 20px; padding: 15px; background: #f8f9fa; border-radius: 8px;">
                     <label style="cursor: pointer; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">
                         <input type="radio" name="admin-role" value="admin" onchange="showAdminInputs()">
                         <strong>Admin (Full Access)</strong>
                     </label>
                     <div style="margin-left: 24px; font-size: 12px; color: #666; padding: 5px 0;">
                         Complete system control. Create, edit, delete other admin accounts. Full access to all features and settings.
                     </div>
                     <label style="cursor: pointer; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">
                         <input type="radio" name="admin-role" value="co-admin" onchange="showAdminInputs()">
                         <strong>Co-Admin (Limited Access)</strong>
                     </label>
                     <div style="margin-left: 24px; font-size: 12px; color: #666; padding: 5px 0;">
                         User & File Management. Approve/reject user registrations. Limited access to features.
                     </div>
                     <label style="cursor: pointer; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">
                         <input type="radio" name="admin-role" value="sub-admin" onchange="showAdminInputs()">
                         <strong>Sub-Admin (Approver)</strong>
                     </label>
                     <div style="margin-left: 24px; font-size: 12px; color: #666; padding: 5px 0;">
                         User Approver. Accept/Reject Registrations. Basic access to user management.
                     </div>
                 </div>
                
                <!-- Hidden Input Fields (shown when role is selected) -->
                <div id="admin-inputs-container" style="display: none;">
                    <!-- Stacked/Vertical Input Fields -->
                    <div style="margin-bottom: 15px;">
                        <label for="create-admin-fullname" style="display: block; margin-bottom: 5px; font-weight: bold;">Full Name:</label>
                        <input type="text" id="create-admin-fullname" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;">
                    </div>
                    
                    <div style="margin-bottom: 15px;">
                        <label for="create-admin-email" style="display: block; margin-bottom: 5px; font-weight: bold;">Email:</label>
                        <input type="email" id="create-admin-email" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;">
                    </div>
                    
                    <div style="margin-bottom: 15px;">
                        <label for="create-admin-password" style="display: block; margin-bottom: 5px; font-weight: bold;">Password:</label>
                        <div style="position: relative;">
                            <input type="password" id="create-admin-password" style="width: 100%; padding: 10px; padding-right: 40px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;">
                            <span id="create-admin-password-toggle" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); cursor: pointer; color: #888; font-size: 14px;" onclick="togglePasswordVisibility()">
                                <i class="fas fa-eye"></i>
                            </span>
                        </div>
                    </div>
                    
                    <div id="grade-section" style="display: none; margin-bottom: 15px;">
                        <label for="create-admin-grade" style="display: block; margin-bottom: 5px; font-weight: bold;">Grade:</label>
                        <select id="create-admin-grade" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;">
                            <option value="Grade 11">Grade 11</option>
                            <option value="Grade 12">Grade 12</option>
                        </select>
                    </div>
                    <div id="section-section" style="display: none; margin-bottom: 15px;">
                        <label for="create-admin-section" style="display: block; margin-bottom: 5px; font-weight: bold;">Section/Strand/Program:</label>
                        <input type="text" id="create-admin-section" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;">
                    </div>
                    <button type="submit" class="btn" id="create-user-btn" style="width: 100%; padding: 12px; background: #0057b8; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 16px;">Create User</button>
                </div>
                <div id="select-role-message" style="text-align: center; padding: 20px; color: #666; font-style: italic;">
                    Please select an Admin Role above to continue
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="add-user-modal" class="modal">
        <div class="modal-content">
            ...
            <form id="add-user-form">
                ...
                <input type="text" id="add-user-fullname" required>
                <label for="add-user-email">School Email:</label>
                <input type="email" id="add-user-email" required>
                <label for="add-user-personal-email">Personal Email:</label>
                <input type="email" id="add-user-personal-email" required>
                ...
                <div id="add-user-grade-section" style="display: none;">
                    <label for="add-user-grade">Grade:</label>
                    <select id="add-user-grade">
                        <option value="Grade 11">Grade 11</option>
                        <option value="Grade 12">Grade 12</option>
                    </select>
                </div>
                <label for="add-user-section">Section/Strand:</label>
                <input type="text" id="add-user-section" required>
    ...
    <div id="edit-user-modal" class="modal">
        <div class="modal-content">
            <div style="position: relative; margin-bottom: 20px;">
                ...
                <span class="close-modal" onclick="closeEditUserModal()" style="position: absolute; right: 0; top: 0; cursor: pointer; font-size: 28px; color: #aaa;">&times;</span>
            </div>
            <form id="edit-user-form">
                <!-- Stacked Input Fields -->
                <div style="margin-bottom: 15px;">
                    <label for="edit-user-id" style="display: block; margin-bottom: 5px; font-weight: bold;">ID:</label>
                    <input type="text" id="edit-user-id" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;">
                </div>
                
                <div style="margin-bottom: 15px;">
                    <label for="edit-user-fullname" style="display: block; margin-bottom: 5px; font-weight: bold;">Full Name:</label>
                    <input type="text" id="edit-user-fullname" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;" required>
                </div>
                
                <div style="margin-bottom: 15px;">
                    <label for="edit-user-email" style="display: block; margin-bottom: 5px; font-weight: bold;">Email:</label>
                    <input type="email" id="edit-user-email" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;">
                </div>
                
                <!-- Admin Roles Section -->
                <div id="edit-admin-roles-section" style="margin-bottom: 15px;">
                    <label style="font-weight: bold; display: block; margin-bottom: 10px;">Admin Role:</label>
                    <div style="display: flex; flex-direction: column; gap: 10px; padding: 15px; background: #f8f9fa; border-radius: 8px;">
                        <label style="cursor: pointer; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">
                            <input type="radio" name="edit-admin-role" value="admin"> 
                            <strong>Admin (Full Access)</strong>
                        </label>
                        <div style="margin-left: 24px; font-size: 12px; color: #666; padding: 5px 0;">
                            Complete system control. Create, edit, delete other admin accounts.
                        </div>
                        <label style="cursor: pointer; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">
                            <input type="radio" name="edit-admin-role" value="coadmin"> 
                            <strong>Co-Admin (Limited Access)</strong>
                        </label>
                        <div style="margin-left: 24px; font-size: 12px; color: #666; padding: 5px 0;">
                            User management and file oversight. Cannot view other admins.
                        </div>
                        <label style="cursor: pointer; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">
                            <input type="radio" name="edit-admin-role" value="subadmin">
                            <strong>Sub-Admin (User Approver)</strong>
                        </label>
                        <div style="margin-left: 24px; font-size: 12px; color: #666; padding: 5px 0;">
                            Accept or reject user registrations. Manage pending user accounts.
                        </div>
                    </div>
                </div>
                
                <!-- Regular user fields (for non-admin roles) -->
                <div id="edit-regular-user-fields" style="display: none;">
                    <label for="edit-user-role">Role:</label>
                    <select id="edit-user-role" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 4px; margin-bottom: 15px;">
                        <option value="senior_high">Senior High</option>
                        <option value="college">College</option>
                        <option value="teacher">Teacher</option>
                    </select>
                    <label for="edit-user-section">Section/Strand:</label>
                    <input type="text" id="edit-user-section" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 4px;">
                </div>
                
                <button type="submit" class="btn" style="width: 100%; padding: 12px; background: #0057b8; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 16px;">Save</button>
                <button type="button" onclick="closeEditUserModal()" class="btn" style="width: 100%; padding: 12px; background: #6c757d; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 16px; margin-top: 10px;">Cancel</button>
            </form>
        </div>
    </div>
